...
#define IO_SENSOR_0     GPIOA, LL_GPIO_PIN_0
#define IO_SENSOR_1     GPIOA, LL_GPIO_PIN_1
...
#define ADC_CH_SENSOR_0 LL_ADC_CHANNEL_0
#define ADC_CH_SENSOR_1 LL_ADC_CHANNEL_1
